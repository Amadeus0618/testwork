...
public class TestIndex {
    ...
    public void getDoc() throws Exception {
        GetRequest request = new GetRequest("xc_course", "doc", "R8ENhnABStTvxTMqNSwA");
    ...
    public void updateDoc() throws Exception {
        UpdateRequest request = new UpdateRequest("xc_course", "doc", "R8ENhnABStTvxTMqNSwA");
        Map<String, Object> param = new HashMap<>();
        param.put("name", "spring boot实战");
        request.doc(param);
        UpdateResponse updateResponse = restHighLevelClient.update(request);
        System.out.println(updateResponse.status() + "_------------------------------");
    }

    @Test
    public void deleteDoc() throws Exception {
        DeleteRequest deleteRequest = new DeleteRequest("xc_course", "doc", "R8ENhnABStTvxTMqNSwA");
